...
class DirichletBCLoss(BCLossFunction):
    ...
    def load_step(self, params, domain, t):
        ...
        #   us_predicted = \
        #       vmap(domain.physics.field_values, in_axes=(None, 0, None))(
        ...
        def vmap_func(bc):
            coords = domain.coords[domain.mesh.nodeSets[bc.nodeSet]]
            us_predicted = vmap(
                domain.physics.field_values,
                in_axes=(None, 0, None)
            )(field_network, coords, t)[:, bc.component]
            us_expected = vmap(bc.function, in_axes=(0, None))(coords, t)
...
class NeumannBCLoss(BCLossFunction):
    ...
    def load_step(self, params, domain, t):
        ...
        error = jnp.square(
            vmap(func, in_axes=(None, 0, None, 0))(params, xs, t, ns)
        ).mean()
        return error
